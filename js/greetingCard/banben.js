...
//      alert("chrome"+browser.chrome);
		console.log("chrome"+browser.chrome);
    } 
...
//      alert("safari"+browser.safari);
		...
		var banben = parseInt(browser.safari);
		if(banben<600){//------------------------------------------------------------针对低版本safari左右旋转无效
			$(".shadowLeft,.shadowRight").show();
		}
		else{
//			$(".consoleTxt").html("当前版本为："+banben);
		}
    }
    // Opera 9.50+  
    if (browser.opera)  
